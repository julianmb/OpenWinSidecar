...
public class SpacedeskServiceController
{
    private const string ServiceName = "spacedeskService";
    ...
    public SpacedeskServiceState GetServiceState()
    {
        try
        {
            using var controller = new ServiceController(ServiceName);
            ...
            {
                ServiceControllerStatus.Running => SpacedeskServiceState.Running,
                ServiceControllerStatus.Stopped => SpacedeskServiceState.Stopped,
                ServiceControllerStatus.StartPending => SpacedeskServiceState.StartPending,
                ServiceControllerStatus.StopPending => SpacedeskServiceState.StopPending,
                ServiceControllerStatus.Paused => SpacedeskServiceState.Paused,
                ServiceControllerStatus.PausePending => SpacedeskServiceState.PausePending,
                ServiceControllerStatus.ContinuePending => SpacedeskServiceState.ContinuePending,
                _ => SpacedeskServiceState.Unknown
            };
        }
        catch (InvalidOperationException)
        {
            return SpacedeskServiceState.NotFound;
        }
        catch
        {
            return SpacedeskServiceState.Unknown;
        }
    }
